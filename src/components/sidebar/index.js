...
const SideBar = () => {
    ...
    return (
        <div className="flex-col items-center justify-between hidden sm:flex w-14 bg-neutral-100 md:w-60 h-dvh">
            <div className="my-4">
                <Logo />
                <LogoSmall />
            </div>
            <div className="w-full h-1/2">
                <Link to="/play">
                    <div
                        className="flex items-center p-2 my-2 text-xl font-semibold transition-transform duration-300 rounded-sm md:mx-6 hover:bg-neutral-700 hover:text-white hover:cursor-pointer hover:scale-105"
                    ...
                    >
                        ...
                        <h1 className="hidden ml-2 md:block">Play</h1>
                    </div>
                </Link>
                <Link to="/rules">
                    <div
                    ...
                    >
                        ...
                        <h1 className="hidden ml-2 md:block">Rules</h1>
                    </div>
                </Link>
                <Link to="/watch">
                    <div
                    ...
                    >
                        ...
                        <h1 className="hidden ml-2 md:block">Watch</h1>
                    </div>
                </Link>
                <Link to="/socials">
                    <div
                    ...
                    >
                        ...
                        <h1 className="hidden ml-2 md:block">Socials</h1>
                    </div>
                </Link>
                <Link to="/account">
                    <div
                    ...
                    >
                        ...
                        <h1 className="hidden ml-2 md:block">Account</h1>
                    </div>
                </Link>
            </div>
            <div className="w-full py-4 bg-neutral-200">
                <div className="flex items-center p-2 my-2 text-xl font-semibold transition-transform duration-300 rounded-sm md:mx-6 hover:cursor-pointer hover:scale-105">
                    <DarkModeIcon width={6} height={6} />
                    <h1 className="hidden ml-2 md:block">Dark Mode</h1>
                </div>
                <Link to="/settings">
                    <div className="flex items-center p-2 my-2 text-xl font-semibold transition-transform duration-300 rounded-sm md:mx-6 hover:cursor-pointer hover:scale-105">
                        <SettingsIcon width={6} height={6} />
                        <h1 className="hidden ml-2 md:block">Settings</h1>
                    </div>
                </Link>
                <Link to="/help">
                    <div className="flex items-center p-2 my-2 text-xl font-semibold transition-transform duration-300 rounded-sm md:mx-6 hover:cursor-pointer hover:scale-105">
                        <HelpIcon width={6} height={6} />
                        <h1 className="hidden ml-2 md:block">Help</h1>
                    </div>
                </Link>
            </div>
        </div>
